                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 offset-md-0">
                                <div class="form-group">
                                    <input type="text" class="form-control @error('name.'.($i+1)) is-invalid @enderror" wire:model="name.{{$i+1}}" id="name.{{$i+1}}" placeholder="Enter Name" name="name.{{$i+1}}" value="">
            ...
            <div class="card-body">
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 offset-md-0">
                            <div class="form-group">
                                <input type="text" class="form-control @error('title') is-invalid @enderror" wire:model="title" id="title" placeholder="Enter Title" name="title" value="">
                ...
                <button type="button" wire:click.prevent="editSubmission" class="btn btn-success btn-md float-right" ><i class="fas fa-paper-plane"></i> Submit</button>
